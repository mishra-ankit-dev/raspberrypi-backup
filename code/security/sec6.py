...
class write_serial_device:
    ...
    def __init__(self, serialDevice):
        ...
        lcd.lcd_string("%s CONNECTED" %serialDevice, LCD_LINE_1)
...
class myKeypad:
    ...
    def __init__(self,purpose):
        ...
        lcd.lcd_string("KEYPAD CONNECTED", LCD_LINE_2)
...
class my_lcd:
    ...
    def lcd_init(self):
        ...
        time.sleep(E_DELAY)
        self.lcd_string("RPi lcd", LCD_LINE_1)
        self.lcd_clear()
        ...
        if key:
            ...
            if key == '#':
                ...
                if pin == "1234":
                    ...
                    lcd_string("PUSH GATE TO OPEN", LCD_LINE_1)
                    time.sleep(2)                    
                    lcd.lcd_clear()
                    check = False
                    ...
                    lcd_string("WAIT CHECKING PIN...", LCD_LINE_1)                    
