...
class cam:
    ...
    def __init__(self,purpose):
        ...
        # Removed 'global camera' and added self with attribute 'camera'
        #global camera
        self.purpose = purpose
    ...
    def image(self, location):
        ...
        self.time.sleep(2) # hang for preview for 5 seconds
        self.camera.capture(self.location)
        self.camera.stop_preview()
        print("image captured at %s" %self.location)

    def video(self, name, onTime, location):
        ...
        self.camera.stop_preview()
        print("video captured at %s" %self.location)
