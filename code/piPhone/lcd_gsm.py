...
def main():
  ...
  # Send some test
  lcd_string("Ankit mishra  ",LCD_LINE_1)
  lcd_string("welcomes you",LCD_LINE_2)
  time.sleep(3)


  port.write('ATD9993141346;'+'\r')
  rcv = port.readline()
  lcd_string("CALLING", LCD_LINE_1)
  lcd_string("9713490290", LCD_LINE_2)
  time.sleep(10)
  lcd_string("call disconnect", LCD_LINE_1)
  lcd_string("user busy", LCD_LINE_2)
  time.sleep(2)
